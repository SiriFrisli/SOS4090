...
### Document ###
## Web scraping
# OBS Tar lang tid ?? kj??re.
# Document har endret sideoppbygning etter at jeg samlet inn tekstmaterialet, s?? denne koden fungerer ikke lenger
...
for(i in seq(from = 2003, to = 2021, by = 1)) {
  ...
  j <- 0
  while(fortsettloop){
    Sys.sleep(2:10) # Venter 2-10 sek mellom hver side for ?? ikke overbelaste serveren
    j <- j+1
    if(j == 1){
...
# Lager ordskyer
egne_stoppord_tibble <- tibble(word = c("m??", "m??tte", "sier", "f??", "mer", "f??r", "ta", "g??r",
                                        "gikk", "dag", "alts??", "??r", "nok", "hele", "mens", "gj??r", "gj??re", "gjort", "f??tt", "se",
                                        "ser", "sett", "st??r", "fikk", "tar", "tatt", "sa", "g??", "vet", "the", "new", "way", "all",
                                        "last", "get", "why", "who", "you", "me", "us", "your", "mine", "will", "this", "that", "u",
                                        "mest", "one", "two", "have", "are", "or", "without", "with", "his", "to", "of","and", "in", "a",
                                        "is", "on", "it", "was", "as", "af", "och", "sig", "att", "he", "not", "be", "they", "an", "??r",
                                        "till", "inte", "we", "but", "their", "jo", "f??r", "which","would", "its", "if", "there",
                                        ...
                                        "second", "if", "until", "into","from", "does", "its", "his", "theirs", "them", "jag", "fr??n",
                                        "n??r", "ska", "hon", "alla","d??r", "vad", "andra", "vara", "hur", "nu", "finns", "ocks??", "nu",
                                        "n??got", "n??gon", "hvad","nu", "havde", "noget", "mig", "blive", "nogle", "os", "vores", "h??r",
                                        "??n", "??ver", "allt", "bara","these", "than", "him", "now", "op", "ind", "uden", "g??re", "g??r",
                                        "blandt", "detta", "sedan", "efter","deras", "mycke", "mycket", "efter", "??ven", "s??ger", "utan",
                                        "sina", "fr??", "bliver", "siger", "fik","nogen", "sagde", "sige", "g??rne", "mer", "brug",
                                        "brugt", "about", "only", "even", "mer", "brug","giv", "giver", "seem", "like", "most", "andre",
                                        "m??nge", "??ven", "m??st", "m??sta", "n??gre"))
